...
image:{PAGES_URL}/images/051_Cannot-use-import-statement.png[]
...
このキーで検索すればたくさんのweb記事がヒットした。例えば link:https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Modules#applying_the_module_to_your_html[Mdn, JavaScript modules] も読んだ。

=== 説明

`my-minista-project/src/layouts/index.ts` を修正した。
