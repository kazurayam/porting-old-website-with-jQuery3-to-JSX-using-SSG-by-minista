...
src属性が書き換えられて dist/assets ディレクトリ下に出力されたjavascriptファイルを適切に指し示している。pluginEntryはちゃんと動いたように見える。

Gitタグ [step04-done] をcheckoutすればここまでの対処を完了したソースコードを取り出すことができます。
