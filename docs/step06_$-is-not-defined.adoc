...
Gitタグ link:https://github.com/kazurayam/porting-old-website-with-jQuery3-to-JSX-using-SSG-by-minista/tree/step06-done[step06-done] をcheckoutすれば ここまでの対処を完了したソースコードを取り出すことができます。
